  ...
  const testimonials: Testimonial[] = [
    {
      ...
      occupation: '직장인',
      rating: 5,
      content: '집안일이 이렇게 체계적으로 관리될 줄 몰랐어요. 3D 맵으로 한눈에 보이니까 놓치는 일이 없고, 특히 냉장고 유통기한 알림이 정말 유용해요. 덕분에 음식 낭비가 거의 없어졌어요.',
    ...
    },
    {
      ...
      occupation: '대학생',
      rating: 4,
      content: '자취하면서 집 관리가 정말 어려웠는데, 다정한으로 청소 일정 짜고 냉장고 관리하니까 엄마한테 칭찬받았어요 ㅋㅋ 특히 3D로 보이는 게 게임 같아서 재미있게 할 수 있어요.',
      highlight: '게임 같아서 재미있게 할 수 있어요',
      platform: 'android',
      avatar: '👨🏻‍🎓'
    },
    {
