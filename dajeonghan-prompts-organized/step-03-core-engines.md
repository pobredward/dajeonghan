...
### 다음 단계
- **Step 04**: 청소 모듈 구현 (병렬 가능)
- **Step 05**: 냉장고 모듈 구현 (병렬 가능)
- **Step 06**: 약 모듈 구현 (병렬 가능)

### 이 단계를 건너뛸 수 없는 이유
- Step 04~06의 모든 모듈이 이 엔진들을 사용합니다
...
**다정한**의 가장 큰 차별화 요소는 "공통 엔진"입니다. 청소, 냉장고, 약 모듈이 각자 주기/미루기 로직을 따로 구현하는 대신, 하나의 통합된 엔진을 공유합니다.
