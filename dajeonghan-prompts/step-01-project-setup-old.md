...
- ✅ Web 앱 등록 완료
- ✅ iOS 앱 등록 완료 (`GoogleService-Info.plist` 준비됨)
- ✅ Android 앱 등록 완료 (`google-services.json` 준비됨)
- ✅ Authentication, Firestore, Storage 활성화됨

### 3. Apple Developer
- ✅ Identifier 등록: `com.onmindlab.dajeonghan`
- ✅ Provisioning Profile 생성: `[expo]_comonmindlabdajeonghan.mobileprovision`
