# Step 09. 개인정보 및 법적 준수

> **🎯 목표**: 개인정보보호법 및 앱 스토어 정책을 완벽히 준수하는 안전한 서비스 구축
...
### 이전 단계 요구사항
- ✅ Step 08 완료: Firebase 설정 (계정 삭제 기능 위해)
- ✅ Step 07 완료: UI/UX (개인정보처리방침 화면 필요)
...
**왜 중요한가?**
- 개인정보보호법 위반 시 최대 5억원 과징금
- 앱 스토어 거부 사유 1위: 개인정보 정책 미비
- 사용자 신뢰 구축의 기본
...
3. **앱 스토어 정책**
   ...
   - **App Store**: App Privacy Details, 데이터 수집 투명성
...
1. "서비스"란 다정한가 제공하는 생활 관리 애플리케이션을 의미합니다.
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          다정한는 약 복용 일정을 기록하고 알림을 제공하는 도구일 뿐,
