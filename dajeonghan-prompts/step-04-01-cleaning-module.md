...
> **🎯 목표**: "오늘 할 청소"를 자동으로 추천하는 스마트 청소 관리 시스템 구현
...
**의존성**: Step 03 완료 필수  
**병렬 가능**: Step 04-02, 04-03, 04-04, 04-05와 동시 진행 가능  
**예상 소요 시간**: 1-1.5일  
**난이도**: ⭐⭐⭐
...
다정한의 청소 모듈은 두 가지 경쟁 앱의 장점을 결합합니다:

1. **Tody 방식**: 긴급도 기반 우선순위 자동 생성
2. **Sweepy 방식**: 포인트 기반 오늘 할 만큼만 추천

### 주요 기능

- **방/공간 기반 구성**: 거실, 침실, 화장실, 주방 등
- **환경별 분기**: 세탁기/건조기 유무에 따른 테스크 변경
- **우선순위 자동 생성**: 건강 우선순위 (화장실, 주방) 높음
- **10분 코스**: 빠르게 끝낼 수 있는 작업만 필터링
...
## 다음 단계
- **step-04-02-fridge-module.md**: 냉장고 모듈 구현
