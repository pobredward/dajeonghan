...
export const FURNITURE_DEFAULTS: Record<FurnitureType, {
  ...
  bed: { emoji: '🛏️', defaultSize: { width: 50, height: 50 }, category: 'bedroom' },
  desk: { emoji: '🪑', defaultSize: { width: 50, height: 50 }, category: 'study' },
  chair: { emoji: '💺', defaultSize: { width: 50, height: 50 }, category: 'living' },
  sofa: { emoji: '🛋️', defaultSize: { width: 50, height: 50 }, category: 'living' },
  table: { emoji: '🪑', defaultSize: { width: 50, height: 50 }, category: 'living' },
  fridge: { emoji: '🧊', defaultSize: { width: 50, height: 50 }, category: 'kitchen' },
  sink: { emoji: '🚰', defaultSize: { width: 50, height: 50 }, category: 'kitchen' },
  stove: { emoji: '🍳', defaultSize: { width: 50, height: 50 }, category: 'kitchen' },
  toilet: { emoji: '🚽', defaultSize: { width: 50, height: 50 }, category: 'bathroom' },
  bathtub: { emoji: '🛁', defaultSize: { width: 50, height: 50 }, category: 'bathroom' },
  shower: { emoji: '🚿', defaultSize: { width: 50, height: 50 }, category: 'bathroom' },
  washing_machine: { emoji: '🧺', defaultSize: { width: 50, height: 50 }, category: 'utility' },
  closet: { emoji: '👔', defaultSize: { width: 50, height: 50 }, category: 'bedroom' },
  bookshelf: { emoji: '📚', defaultSize: { width: 50, height: 50 }, category: 'study' },
  tv: { emoji: '📺', defaultSize: { width: 50, height: 50 }, category: 'living' },
